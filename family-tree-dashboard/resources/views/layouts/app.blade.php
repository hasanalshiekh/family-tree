...
<head>
    ...
    <title>@yield('title', 'شجرة العائلة') - Family Tree Dashboard</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('family.create') }}">
                    ...
                    @if(isset($family))
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('family.dashboard', $family->id) }}">
                            <i class="fas fa-tachometer-alt me-1"></i>
                            الداش بورد
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('family.tree', $family->id) }}">
